...
export function NewsPage() {
  ...
  return (
    <>
      <SEO 
        title={selectedCategory === 'Todos' ? 'Noticias' : `Noticias de ${selectedCategory}`}
        description={selectedCategory === 'Todos' 
          ? 'Mantente informado con las últimas noticias y acontecimientos más relevantes en Toca Stereo.'
          : `Las últimas noticias de ${selectedCategory.toLowerCase()} en Toca Stereo. Información actualizada y relevante.`}
        type="website"
      />
