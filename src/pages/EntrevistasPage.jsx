  ...
  return (
    <>
      <SEO 
        ...
        description="Conoce de cerca a tus artistas favoritos en entrevistas exclusivas. Las mejores conversaciones con los protagonistas de la música en Toca Stereo."
        type="website"
      />
