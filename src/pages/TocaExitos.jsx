...
export function TocaExitosPage() {
  ...
  return (
    <>
      <SEO 
        title="Toca Éxitos - Las Canciones Más Populares"
        description="Descubre las canciones más populares del momento en nuestra selección musical Toca Éxitos. Escucha los mejores hits y mantente al día con la música que está marcando tendencia."
        type="music"
      />
